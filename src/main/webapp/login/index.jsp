...
<script language="javascript">
	function ale() {//这个基本没有什么说的，就是弹出一个提醒的对话框
		alert("我敢保证，你现在用的是演示一");
	}
	function firm() {//利用对话框返回的值 （true 或者 false）
		if (confirm("你确信要转去 天轰穿的博客？")) {//如果是true ，那么就把页面转向thcjp.cnblogs.com
...
<body>
	...
	<p>2：一般用于确认，返回 true 或者 false ，所以可以轻松用于
		ifJSP中三种弹出对话框的用法实例elseJSP中三种弹出对话框的用法实例判断</p>

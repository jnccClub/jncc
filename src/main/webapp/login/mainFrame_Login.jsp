...
<div class="mainFrame_Login" style="text-align:center;"
	...
	<form id="userLoginForm">
		<input name="userInfo.username" placeholder="请输入学号" class="loginUsername"
			required /> <input name="userInfo.password"
			placeholder="请输入密码" class="loginUserPasswd" type="password" required />
		<textarea rows="4" cols="50" name="subject"
			placeholder="Please enter your message" class="message" required></textarea>
		<p id="loginErrTips">  </p>
		<input type="button" class="loginBtn" type="submit" value="提交" id="loginSubmit"/>
...
<script>
	$(document).ready(function() {
		...
		$("#loginSubmit").click(function() {// 必须先对提交表单数据数据进行序列化，采用jQuery的serialize()方法
